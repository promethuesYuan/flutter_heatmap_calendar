...
void main() {
  group('HeatMapDay Widget', () {
    ...
    testWidgets('should have only one AnimatedOpacity', (WidgetTester tester) async {
      await tester.pumpWidget(app);
    ...
    testWidgets('should find one widget with given text', (WidgetTester tester) async {
      await tester.pumpWidget(app);
